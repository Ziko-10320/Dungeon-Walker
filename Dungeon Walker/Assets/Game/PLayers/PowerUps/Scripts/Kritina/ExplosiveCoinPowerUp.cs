...
public class ExplosiveCoinsPowerUp : MonoBehaviour
{
    ...
    private Queue<GameObject> GetPoolForType(CoinType type)
    {
        switch (type)
        {
            case CoinType.Golden: return goldenCoinPool;
            case CoinType.Silver: return silverCoinPool;
            case CoinType.Bronze: return bronzeCoinPool;
            default: return null;
        }
    }
    public void ReturnCoinToPool(GameObject coin, CoinType type)
    {
